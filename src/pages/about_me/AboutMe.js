      ...
      <div className='AboutMe'>
         ...
         <div className='center-big-box'>
            ...
            <div className='top-box'>
               <img className='each-image' src={me} />
            ...
            <div className='bottom-box'>
               ...
               <ul className='list-style'>
                  ...
                  <li>Game design</li>
                  <li>Playing guitar and drums <a class='better-link' href='https://www.instagram.com/inframings/' target="_blank" rel="noopener noreferrer">(See my band here!)</a></li>
               </ul>
            </div>
